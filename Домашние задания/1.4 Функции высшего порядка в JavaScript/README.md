# Дополнительное задание к лекции «Функции высшего порядка в JavaScript»
...
![графическое представление](../../pics/9zZGdlJbxM.png)
...
![графическое представление](../../JS-Koans/Jasmine/results/sucessed_tasks_1_4.png)
